...
_local_rubrics = Path(__file__).resolve().parent / "rubrics"
RUBRICS_DIR = _local_rubrics if _local_rubrics.exists() else Path(__file__).resolve().parent.parent.parent / "rubrics"
