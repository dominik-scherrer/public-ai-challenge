...
from public_ai_challenge.alternative_pipeline_publicai.config import Settings, load_settings
from public_ai_challenge.alternative_pipeline_publicai.contracts import load_discovery
from public_ai_challenge.alternative_pipeline_publicai.observability import configure
...
def _failure(error: Exception) -> None:
    from public_ai_challenge.alternative_pipeline_publicai.agents import ModelConfigurationError
    from public_ai_challenge.alternative_pipeline_publicai.builder import BuildError
    from public_ai_challenge.alternative_pipeline_publicai.crawler import CrawlError
...
def discover(
    ...
    from public_ai_challenge.alternative_pipeline_publicai.pipeline import discover as discover_pipeline
...
def build(discovery_json: Path, out: Annotated[Path, typer.Option()]) -> None:
    ...
    from public_ai_challenge.alternative_pipeline_publicai.builder import build as build_package
