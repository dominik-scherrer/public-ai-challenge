...
from pipeline.judge.adapters import iter_delivered_inventories, load_claims_from_inventory

HANDOFF_DIR = Path(__file__).resolve().parents[3] / "pipeline" / "handoff" / "delivery-2026-09-24"
