...
from public_ai_challenge.phase1_scout.publicai_contracts import Discovery, packaging_issues


@pytest.fixture
def discovery_payload() -> dict:
    """Read deliberately fictional examples, never live municipal findings."""
    path = Path(__file__).resolve().parent / "fixtures" / "representative.json"
