...
from public_ai_challenge.phase1_scout.agents import heuristic_strategy
from public_ai_challenge.phase1_scout.catalog import load_service_index
from public_ai_challenge.phase1_scout.contracts import ReconResult, ScoutStrategy, StrategyMode
from public_ai_challenge.phase1_scout.runtime import PageIR, broad_crawl, normalize_url
...
class RuntimeTests(unittest.TestCase):
    ...
    def test_broad_crawl_skips_redirect_duplicates_and_prioritises_admin(self):
        ...
        with patch("public_ai_challenge.phase1_scout.runtime.fetch_page", side_effect=fake_fetch):
