...
from public_ai_challenge.phase1_scout.agents import (
    choose_strategy,
    heuristic_interpret,
    heuristic_strategy,
    inspect_service,
)
from public_ai_challenge.phase1_scout.app import (
    _is_government,
    _parent_domain,
...
from public_ai_challenge.phase1_scout.catalog import all_terms, load_service_index
from public_ai_challenge.phase1_scout.contracts import (
    HandlingType,
    IndexRelation,
    InteractionType,
    ReconResult,
...
class AgentsAndAppTests(unittest.IsolatedAsyncioTestCase):
    ...
    @patch("public_ai_challenge.phase1_scout.app.recon")
    @patch("public_ai_challenge.phase1_scout.app.execute_strategy")
    ...
    def test_crawl_records_network_failures(self):
        ...
        from public_ai_challenge.phase1_scout.contracts import DiscoveryFailure, ScoutStrategy
        from public_ai_challenge.phase1_scout.runtime import broad_crawl, targeted_crawl
        ...
        with patch("public_ai_challenge.phase1_scout.runtime.fetch_page", side_effect=urllib.error.URLError("Connection refused")):
            with self.assertLogs("public_ai_challenge.phase1_scout.runtime", level="WARNING") as cm:
        ...
        with patch("public_ai_challenge.phase1_scout.runtime.fetch_page", side_effect=TimeoutError("Timed out")):
            with self.assertLogs("public_ai_challenge.phase1_scout.runtime", level="WARNING") as cm:
    ...
    async def test_agent_call_exceptions_fall_back_to_heuristics(self):
        ...
        from public_ai_challenge.phase1_scout.contracts import IndexRelation, ScoutFinding
        ...
        with patch.dict("os.environ", {"SCOUT_MODEL": "test-model"}):
            with patch("pydantic_ai.Agent", return_value=mock_agent_instance):
                with self.assertLogs("public_ai_challenge.phase1_scout.agents", level="WARNING") as cm:
