...
from public_ai_challenge.phase1_scout.contracts import ScoutStrategy, StrategyMode
from public_ai_challenge.phase1_scout.runtime import (
    PageIR,
    Parser,
    clean,
    execute_strategy,
...
class RuntimeHardeningTests(unittest.TestCase):
    ...
    @patch("public_ai_challenge.phase1_scout.runtime.validate_public_url")
    ...
    @patch("public_ai_challenge.phase1_scout.runtime.fetch_page")
    ...
    def test_targeted_crawl_and_execute_strategy(self):
        ...
        with patch("public_ai_challenge.phase1_scout.runtime.fetch_page") as mock_fetch:
            mock_fetch.return_value = PageIR(
