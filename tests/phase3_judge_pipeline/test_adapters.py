...
from public_ai_challenge.phase3_judge_pipeline.adapters import iter_delivered_inventories, load_claims_from_inventory
...
HANDOFF_DIR = _h1 if _h1.exists() else _h2
