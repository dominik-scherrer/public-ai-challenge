...
from public_ai_challenge.phase3_judge_pipeline.adapters import (
    _evidence_text_for,
)
...
from public_ai_challenge.phase3_judge_pipeline.pipeline import judge_injection, judge_provenance, run_judge
from public_ai_challenge.phase3_judge_pipeline.schemas import Claim, Verdict
...
class JudgePipelineAndProvenanceTests(unittest.TestCase):
    ...
    def test_judge_provenance_decisions(self):
        ...
        with patch("public_ai_challenge.phase3_judge_pipeline.pipeline.call_judge_ensemble") as mock_ensemble:
