...
from public_ai_challenge.alternative_pipeline_publicai.contracts import Discovery
from public_ai_challenge.alternative_pipeline_publicai.runtime import SnapshotRuntime, create_server


def test_recycling_point_must_be_in_structured_location_field() -> None:
    from public_ai_challenge.alternative_pipeline_publicai.contracts import Capability, EvidenceRef, Fact, ServiceEntry, classify_coverage
...
def payload() -> dict[str, Any]:
    ...
    source = Path(__file__).parents[2] / "src/public_ai_challenge/alternative_pipeline_publicai/fixtures/representative.json"
