...
from public_ai_challenge.alternative_pipeline_publicai.contracts import Discovery, packaging_issues


@pytest.fixture
def discovery_payload() -> dict:
    """Read deliberately fictional examples, never live municipal findings."""
    path = Path(__file__).parents[2] / "src/public_ai_challenge/alternative_pipeline_publicai/fixtures/representative.json"
