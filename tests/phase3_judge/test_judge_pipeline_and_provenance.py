...
from public_ai_challenge.phase3_judge.adapters import (
    _evidence_text_for,
)
from public_ai_challenge.phase3_judge.llm import (
    JudgeConfigError,
    extract_and_parse_json,
    load_rubric,
)
from public_ai_challenge.phase3_judge.pipeline import judge_injection, judge_provenance, run_judge
from public_ai_challenge.phase3_judge.schemas import Claim, Verdict
...
class JudgePipelineAndProvenanceTests(unittest.TestCase):
    ...
    def test_judge_provenance_decisions(self):
        ...
        with patch("public_ai_challenge.phase3_judge.pipeline.call_judge_ensemble") as mock_ensemble:
