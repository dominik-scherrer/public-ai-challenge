...
from public_ai_challenge.phase1_scout_pipeline.app import compile_source_bundle, run_scout
...
from public_ai_challenge.phase1_scout_pipeline.discovery import discover_findings
...
class ScoutIntegrationTests(unittest.TestCase):
    ...
    def test_fixture_run_compiles_discovery_json(self):
        ...
        with (
            ...
            patch("public_ai_challenge.phase1_scout_pipeline.app.recon", return_value=(recon_result, root)),
            patch("public_ai_challenge.phase1_scout_pipeline.app.execute_strategy", return_value=[root, waste, patent]),
        ):
