...
from scout.contracts import ScoutStrategy, StrategyMode
...
class RuntimeHardeningTests(unittest.TestCase):
    ...
    @patch("scout.runtime.validate_public_url")
    ...
    @patch("scout.runtime.fetch_page")
    ...
    def test_targeted_crawl_and_execute_strategy(self):
        ...
        with patch("scout.runtime.fetch_page") as mock_fetch:
            mock_fetch.return_value = PageIR(
